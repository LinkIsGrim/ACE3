...
// Assuming a trained male in midst of peak exercise will have a target heart rate of ~180 BPM
// Ref: https://academic.oup.com/bjaed/article-pdf/4/6/185/894114/mkh050.pdf, though we don't take stroke volume change into account
